...
const InputNumber = forwardRef<HTMLInputElement, InputNumberProps>(function InputNumberInner(
  ...
  const [valueLocal, setValueLocal] = useState<string>(value as string)
  ...
  return (
    <div>
      <input className={classNameInput} {...rest} value={value || valueLocal} onChange={handleChange} ref={ref} />
