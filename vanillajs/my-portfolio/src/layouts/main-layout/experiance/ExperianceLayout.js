	...
	useEffect(() => {
		...
		abc.forEach((item, index) => {
			item.addEventListener('click', (e) => {
				...
				abc[index].classList.toggle('!bg-blue-500');
				abc[index].classList.toggle('text-white');
      ...
      <div class="h-screen overflow-y-scroll">
        <div class='flex overflow-x-auto justify-end'>
          <section class='px-[4%] py-20 min-h-screen'>
            <h4 class="uppercase text-sm text-gray-400 onscrool-text transition-all duration-1000 -translate-x-[150%]">EXPERIENCE</h4>
            <h2 class='uppercase text-3xl font-medium mt-8 leading-10 onscrool-text transition-all duration-1000 -translate-x-[150%]'>WORK EXPERIENCE</h2>
